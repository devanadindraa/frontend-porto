import FooterWaveUP from "../waves/FooterWaveUP"

function Footer() {
  return (
    <section>
        <FooterWaveUP/>
      <footer id="Footer" className="mt-[50px] footer px-7 pt-10 pb-6 lg:grid lg:grid-cols-5">
        <div className="relative block h-32 lg:col-span-2 lg:h-full rounded-lg overflow-hidden"
                data-aos="zoom-in"
                data-aos-delay="600"
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8"
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p>
                <span className="text-xs uppercase tracking-wide text-[#8c2b7a]"> Call Me </span>

                <a href="#" className="font-contact block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-3xl">
                  081330234066
                </a>
              </p>
              ...
              <ul className="font-contact mt-8 flex gap-6">
                <li>
                  ...
                  >
                    ...
                    <svg className="logo-contact h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path
                        fillRule="evenodd"
